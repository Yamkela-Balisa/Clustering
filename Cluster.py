...
class Cluster:
    ...
    * Centriod of the given cluster is mean  function of numpy package 
    ...
    """
       * Function to generate new clusters for each generated new centriod 
       * To allocated each data point centriod , calculated distances between data point and  new centriod
       * Centriod with lesser distance from data point mean 
         that data point belong cluster of that centriod * It is stored in the centriod dat 
         for example if 
